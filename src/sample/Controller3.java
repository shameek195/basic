...
public class Controller3 {
    ...
    private void initialize() {
        ...
        try {
            String sql = "SELECT * FROM lecturers where SECTION ='B'";
...
//            comboBox121.setItems(list2);
    ...
    public void setValue() throws SQLException {
        ...
        String sql1 = "SELECT * FROM lecturers where subject='"+str+"' AND section ='B'";
        try {
    ...
    public void refresh() {
        try {
            String sql3 = "SELECT * FROM timetable5b WHERE day='MONDAY' AND hour='1'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='MONDAY' AND hour='3'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='MONDAY' AND hour='4'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='MONDAY' AND hour='5'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='MONDAY' AND hour='7'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='TUESDAY' AND hour='1'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='TUESDAY' AND hour='3'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='TUESDAY' AND hour='4'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='TUESDAY' AND hour='5'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='TUESDAY' AND hour='7'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='WEDNESDAY' AND hour='1'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='WEDNESDAY' AND hour='3'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='WEDNESDAY' AND hour='4'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='WEDNESDAY' AND hour='5'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='WEDNESDAY' AND hour='7'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='THURSDAY' AND hour='1'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='THURSDAY' AND hour='3'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='THURSDAY' AND hour='4'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='THURSDAY' AND hour='5'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='THURSDAY' AND hour='7'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='FRIDAY' AND hour='1'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='FRIDAY' AND hour='3'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='FRIDAY' AND hour='4'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='FRIDAY' AND hour='5'";
            ...
            sql3 = "SELECT * FROM timetable5b WHERE day='FRIDAY' AND hour='7'";
